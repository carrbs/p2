...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: myLock3 = zeros  (sizeInBytes=20)
	load	[r14+8],r4
	add	r4,88,r4
	store	r0,[r4]
	store	r0,[r4+4]
...
!   _temp_701 = _temp_702 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-76]
!   Move address of _temp_700 [_temp_701 ] into _temp_703
!     make sure index expr is >= 0
	load	[r14+-76],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-68]
!   Data Move: _temp_699 = *_temp_703  (sizeInBytes=4)
	load	[r14+-68],r1
	load	[r1],r1
	store	r1,[r14+-84]
!   if _temp_699 == 2 then goto _Label_696		(int)
	load	[r14+-84],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_696
...
!   Data Move: _temp_704 = *_temp_706  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-64]
!   if _temp_704 != 1 then goto _Label_696		(int)
	load	[r14+-64],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_696
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-36]
!   Data Move: _temp_707 = *_temp_711  (sizeInBytes=4)
	load	[r14+-36],r1
	load	[r1],r1
	store	r1,[r14+-52]
!   if _temp_707 == 2 then goto _Label_696		(int)
	load	[r14+-52],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_696
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   Data Move: *_temp_713 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-28],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_716 = &mySelf
	...
	add	r1,4,r1
	store	r1,[r14+-16]
!   Move address of _temp_716 [p ] into _temp_717
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
