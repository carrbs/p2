...
_StringConst_5:
	.word	34			! length
	.ascii	"current thread does not hold lock!"
	.align
_StringConst_4:
	.word	34			! length
	.ascii	"current thread has already locked!"
	.align
_StringConst_3:
	.word	51			! length
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if heldBy == _P_Thread_currentThread then goto _Label_71		(int)
	load	[r14+8],r1
	load	[r1+4],r1
	set	_P_Thread_currentThread,r2
	load	[r2],r2
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if t == 0 then goto _Label_75		(int)
	load	[r14+-32],r1
	mov	0,r2
	cmp	r1,r2
	be	_Label_75
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if heldBy != _P_Thread_currentThread then goto _Label_88		(int)
	load	[r14+8],r1
	load	[r1+4],r1
	set	_P_Thread_currentThread,r2
	load	[r2],r2
